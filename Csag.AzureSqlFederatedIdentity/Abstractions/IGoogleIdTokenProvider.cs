namespace Csag.AzureSqlFederatedIdentity.Abstractions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Returns an ID token for the target service account with audience <c>api://AzureADTokenExchange</c>,
        /// the audience Azure AD expects from a client assertion in workload identity federation.
        /// </summary>
