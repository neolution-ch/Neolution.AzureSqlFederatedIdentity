namespace Neolution.AzureSqlFederatedIdentity.Internal
{
    ...
    /// <summary>
    /// Extension methods for reading OAuth2 scope and options name metadata from the AzureTokenScope enum.
    /// </summary>
    public static class TokenScopeExtensions
    {
        /// <summary>
        /// Gets the options name associated with the specified <see cref="AzureTokenScope"/>.
        /// </summary>
        /// <param name="scope">The token scope.</param>
        /// <returns>The options name.</returns>
        public static string GetOptionsName(this AzureTokenScope scope)
        {
            return scope.GetMetadataAttribute().OptionsName;
        }

        /// <summary>
        /// Gets the identifier associated with the specified <see cref="AzureTokenScope"/>.
        /// </summary>
        /// <param name="scope">The token scope.</param>
        /// <returns>The identifier.</returns>
        public static string GetIdentifier(this AzureTokenScope scope)
        {
            return scope.GetMetadataAttribute().Identifier;
        }

        /// <summary>
        /// Retrieves the <see cref="TokenScopeMetadataAttribute"/> associated with the specified <see cref="AzureTokenScope"/>.
        /// </summary>
        /// <param name="scope">The token scope.</param>
        ...
        /// </exception>
        private static TokenScopeMetadataAttribute GetMetadataAttribute(this AzureTokenScope scope)
        {
